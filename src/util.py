...
NO_ERROR_CONF = NoiseConfiguration(single_qubit_gate_error_probability=0.0,
...
class Circuit:
    ...
    '''
    def __init__(self, mapping: QubitMapping, noise_conf: NoiseConfiguration):
...
class MultiplexingCircuit:
    ...
    def num_detectors(self) -> int:
        assert self.circuit1.num_detectors() == self.circuit2.num_detectors()
        return self.circuit1.num_detectors()
...
class SuppressNoise:
    ...
    def __enter__(self):
        ...
        if isinstance(self.circuit, Circuit):
            ...
            self.noise_conf = self.circuit.circuit1.noise_conf
    ...
    def __exit__(self, ex_type, ex_value, trace):
        ...
        if isinstance(self.circuit, Circuit):
            ...
            self.circuit.circuit2.noise_conf = self.noise_conf
